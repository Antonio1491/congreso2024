...
<header class="header">
  <div class="container">
    <h1 class="header__titulo">Hospedaje</h1>
    <img src="build/img/linea.png" alt="">
    <p> ¡Encuentra tu alojamiento!
    </p>
  </div>
</header>
<main>
  ...
  <div class="container mt-5 hotel">
      ...
      <div class="col-sm-12 col-md-8">
        <div class="row">
          <div class="col-sm-10 col-md-4 text-center">
            <h6 class="tituloTabla">Habitación</h6>
            Estándar
          </div>
