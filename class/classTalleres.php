...
class Taller extends Conexion{
  ...
  <div class="row seccion">
      ...
      <div class="col-md-3 col-sm-12 cuadroAzul">';
        ...
        if($id_taller != 22)
        {
          $html .='<a href="https://app.podiumeeting.com/es/registro/congreso-parques-2024" class="btn btn__primary"> Comprar aquí  </a>  ';
        }
        else{
          $html .= '<h4>Evento Gratuito</h4>';
        }
