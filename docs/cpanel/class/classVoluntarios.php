<?php
    class Voluntarios extends Conexion
    {
      ...
      public function voluntarios($evento){
        $sql = "SELECT a.id_voluntario, a.nombre, a.apellidos, a.email,
              a.celular, a.universidad, a.ciudad, a.pais, a.semblanza, a.razones, 
              c.turno, c.fecha, c.hora_inicio, c.hora_fin
      ...
      public function infoVoluntario($id){
        $sql = "SELECT a.nombre, a.apellidos, a.email,
        a.celular, a.universidad, a.semblanza, a.razones, 
