...
class Evento extends Conexion{
    ...
    public function registrarEvento($evento, $evento_ing, $evento_port,$fecha, $horaI, $hora_fin, $lugar, $lugar_ing, $lugar_port,
                     $descripcion, $descripcion_ing, $descripcion_port, $fotografia, $congreso){
      $sql = "INSERT INTO eventos_sociales VALUES
                  (null, '$evento', '$evento_ing', '$evento_port','$descripcion', '$descripcion_ing',
                  '$descripcion_port','$fecha', '$horaI', '$hora_fin', '$lugar', '$lugar_ing', '$lugar_port',
                   '$fotografia', '$congreso')";
      $resultado = $this->conexion_db->query($sql);
      return $resultado;
    }
