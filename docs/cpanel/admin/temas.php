          ...
          <?php
            ...
            echo "<table class='tablaResultados'>
                    ...
                    foreach ($respuesta as $valor) {
                        ...
                        echo "<tr>
                        <td>".$num ."</td>
                        <td><img src='../../imagenes/".$valor['icono']."'></td>
                        <td>" .$valor['tema']. "</td>
                        <td>" .substr($valor["descripcion"], 0, 40)."...". "</td>

                        <td class='acciones'><a href='editarTema.php?id=".$valor['id']."' title='Editar'><i class='fi-pencil'></i></a> |
                        <a href='eliminarTema.php?id=".$valor['id']."' title='Eliminar' class='eliminar'><i class='fi-x'></i> </a></td>
                        </tr>";
                      }
                    echo "
                    </tbody>
