...
<nav class="menuPrincipal">
  <div class="text-center">
    <figure class="logotipoMenu">
      <img src="https://congresoparques.com/img/logo_congreso_parques_180x74.png" alt="">
    </figure>
  </div>
  <ul class="vertical menu accordion-menu" data-accordion-menu data-submenu-toggle="true" >
    <li>
      ...
      <ul class="vertical menu nested"> -->
        ...
        <li><a href="propuestarPorCalificar.php?id_usuario=<?php echo $usuario ?>"><i class="fi-results"></i> Proposal to evaluate</a>
