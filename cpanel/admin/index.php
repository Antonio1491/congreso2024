...
$array_congresos = $congresos->listaCongresos($_SESSION["tipoUsuario"]);
  ...
  <main class="row expanded contenedorEventos">
    ...
    <section class="column medium-10">
      ...
      <section class="eventos">
        ...
        {
          //directorio servidor
        $dir = $_SERVER['DOCUMENT_ROOT'].'/'.$valor['id'];
        //directorio local
        $dir = $_SERVER['DOCUMENT_ROOT'].'/congresos/'.$valor['id'];
        // $hora_inicio = $congresos->formathora12($valor['hora_inicio']);
        // $hora_fin = $congresos->formathora12($valor['hora_fin']);
        echo "<article id='".$valor["id"]."' class='evento'>
          <div class='menuEvento'>
            ...
            <ul>
              <li>
              <a href='editarCongreso.php?id=" . $valor['id'] . "' title='Editar'>Editar</a>
              </li>
          ...
          <a href='inc/crearSession.php?evento=".$valor['id']."' id='".$valor['id']."'>
          <img src='__DIR__ /../../../build/img/" .$valor["logotipo"]."' alt=''>
          </a>
          </figure>
          <a href='inc/crearSession.php?evento=".$valor['id']."' id='".$valor['id']."'><h2>".$valor['evento']."</h2></a>
          <ul>
            <li><i class='fi-calendar'></i> ".$valor["fecha_inicio"]."</li>
            <li><i class='fi-map'></i> ".$valor["localidad"]."</li>
          </ul>
        </article>";
      }
      ?>
